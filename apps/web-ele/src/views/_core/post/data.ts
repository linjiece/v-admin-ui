...
export function getPostLevelOptions() {
  return [
    { label: $t('post.levels.HNGX_001'), value: 0 },
    { label: $t('post.levels.HNGX_002'), value: 1 },
    { label: $t('post.levels.HNGX_003'), value: 2 },
    { label: $t('post.levels.HNGX_004'), value: 3 },
    { label: $t('post.levels.HNGX_005'), value: 4 },
  ];
}
