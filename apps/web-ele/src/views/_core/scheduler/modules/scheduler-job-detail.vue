          ...
          <template #default>
            ...
            >
              <template v-for="log in logs" :key="log.id">
                <!-- 日志项 -->
                <div
                  class="rounded-lg border border-gray-200 p-3 transition-all hover:border-primary hover:shadow-md dark:border-gray-700"
                >
            ...
            >
              <template v-for="log in logs" :key="log.id">
                <!-- 日志卡片 -->
                <div
                  class="flex flex-col gap-3 rounded-lg border border-gray-200 p-4 transition-all hover:border-primary hover:shadow-lg dark:border-gray-700"
                >
                  <!-- 顶部：状态标签 -->
                  <div class="flex items-center justify-between">
                    <ElTag
